...
import { provincesData } from '../data/mozLocations'
...
export default function CadastroProdutor() {
  ...
  // Listas para selects
  const provincias = Object.keys(provincesData || {})
  const distritos = registro.provincia && provincesData[registro.provincia] 
    ? Object.keys(provincesData[registro.provincia]) 
    : []
  ...
  const validarRegistro = () => {
    if (!registro.primeiro_nome.trim()) {
      setErro('Nome é obrigatório')
      return false
    }
    if (!registro.ultimo_nome.trim()) {
  ...
  const submeterRegistro = async (e) => {
    ...
    try {
      ...
      setSucesso('Registo realizado com sucesso! A redirecionar...')
  ...
  const submeterLogin = async (e) => {
    ...
    try {
      ...
      if (dados.utilizador?.tipo !== 'P') {
        throw new Error('Acesso permitido apenas para produtores')
      }
        ...
        <div className="auth-header">
          <div className="logo">
            ...
            <div className="logo-text">
              <h2>SIDES - Produtor</h2>
              <p>Plataforma Digital Sustentável</p>
            </div>
          </div>
          <p className="auth-subtitle">
            {modo === 'registro' 
              ? 'Crie a sua conta para começar a vender na nossa plataforma' 
              : 'Aceda à sua área de produtor'
            }
          </p>
        </div>
            ...
            <div className="form-section">
              ...
              <div className="form-group">
                ...
                <input
                  type="text"
                  value={registro.nuit}
                  onChange={(e) => atualizarRegistro('nuit', e.target.value)}
            ...
            <div className="form-section">
              ...
              <div className="form-grid">
                ...
                <div className="form-group">
                  ...
                  <select
                    ...
                    disabled={!registro.provincia || carregando}
                  >
              ...
              <div className="form-grid">
                <div className="form-group">
                  ...
                  <input
                    type="text"
                    value={registro.localidade}
                    onChange={(e) => atualizarRegistro('localidade', e.target.value)}
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) => atualizarRegistro('codigo_postal', e.target.value)}
